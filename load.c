...
/*   Updated: 2019/01/10 19:12:43 by lchappon         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	sprites_load(t_app *a)
{
	...
	bmp_loadfile(&a->sprites[3], "sprites/skull1.bmp");
	bmp_loadfile(&a->sprites[4], "sprites/skull2.bmp");
	bmp_loadfile(&a->sprites[5], "sprites/skull3.bmp");
	bmp_loadfile(&a->sprites[6], "sprites/skull4.bmp");
